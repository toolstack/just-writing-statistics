...
<h2 class="nav-tab-wrapper">
    ...
    <a href="<?php echo add_query_arg(array( 'page' => $this->plugin_name, 'tab' => 'author-statistics' ), admin_url('admin.php')); ?>" class="nav-tab<?php echo $active_tab['author-statistics']; ?>"><?php echo _x('Author', 'Tab Label', 'just-writing-statistics'); ?></a>
