...
?>
    <div>
        <div class="half jws-chart-container">
            ...
            <h3><?php _e('All Content Word Count', 'just-writing-statistics'); ?></h3>
        ...
        <div class="half jws-chart-container">
            ...
            <h3><?php _e('All Content Item Count', 'just-writing-statistics'); ?></h3>
  ...
  new Chart(WordCountChart, {
    ...
    <div class="full">
        <table class="widefat jws_wrapable">
            <thead>
                <tr>
                    <th colspan="6" class="jws_totals_title"><?php _e('All Content', 'just-writing-statistics'); ?></th>
                </tr>
                <tr>
