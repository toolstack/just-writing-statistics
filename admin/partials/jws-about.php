...
<div id="just-writing-statistics" class="wrap">
    ...
    <div style="text-align: center;">
        ...
        <p><?php printf(esc_html__('a fork of %1$sWP Word Count%2$s', 'just-writing-statistics'),'<a href="https://wpwordcount.com" target="_blank">','</a>'); ?>
        <p><?php printf(esc_html__('by %1$sGreg Ross%2$s', 'just-writing-statistics'),'<a href="https://toolstack.com" target="_blank">','</a>'); ?></p>
        <hr />
